...
payload = {
    ...
    'ddlpart' : 'I',
    'ddlsem': 'I',
    'txtrollno' : '17015570016',
    'txtname' : 'NAVEEN KUMAR ROHILLA',
...
t = soup.find('span', attrs={'id':'lblstatement'})
if t is not None:
    t.decompose()

t = soup.find('span', attrs={'id':'lbl_sub_head3'})
if t is not None:
    t.decompose()

t = soup.find('span', attrs={'id':'lbldisclaimer'})
if t is not None:
    t.decompose()
...
# pdfkit.from_string(str(soup), 'test2.pdf'    
